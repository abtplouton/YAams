...
/**
 * The Map class is the focal point of the <code>tiled.core</code> package. This
 * class also handles notifing listeners if there is a change to any layer or
 * object contained by the map.
 * 
 * @version $Id$
 */
public class Map extends MultilayerPlane {
	 ...
	 * 
	 * @param index
	 *            the index of the removed tileset
	 */
	 ...
	 *             when the tileset is in use on a locked layer
	 */
	 ...
	 */
	/*
	 * public int getTotalTiles() { int totalTiles = 0; Iterator itr =
	 * tilesets.iterator();
	 * 
	 * while (itr.hasNext()) { TileSet cur = (TileSet)itr.next(); totalTiles +=
	 * cur.getTotalTiles(); }
	 * 
	 * return totalTiles; }
	 */
	...
	public String toString() {
		return "Map[" + bounds.width + "x" + bounds.height + "x" + getTotalLayers() + "][" + tileWidth + "x" + tileHeight + "]";
	}
