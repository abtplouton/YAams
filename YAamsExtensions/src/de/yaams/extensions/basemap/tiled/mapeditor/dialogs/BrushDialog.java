...
import de.yaams.extensions.basemap.tiled.mapeditor.brush.RandomBrush;
...
import de.yaams.extensions.basemap.tiled.mapeditor.widget.BrushBrowser;
...
public class BrushDialog extends JDialog implements ActionListener, ItemListener, ChangeListener, PropertyChangeListener,
		ListSelectionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1459679388691451497L;
	...
	private JPanel createShapePanel() {
		...
		presets.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder(PRESETS_TITLE),
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source == okButton) {
			...
			try {
				...
				e1.printStackTrace();
				JOptionPane.showMessageDialog(this, e1.toString(), "Load Brush", JOptionPane.WARNING_MESSAGE);
			}
			repaint();
		}
	}
