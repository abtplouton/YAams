...
public class TileInstancePropertiesDialog extends JDialog implements TableModelListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8243150934312328656L;
	private JTable propertiesTable;
	private PropertiesTableModel tableModel = new PropertiesTableModel();

	private static final String DIALOG_TITLE = "Tile Properties"; // todo:
																	// Resource
																	// this
	private static final String APPLY_BUTTON = Resources.getString("general.button.apply");
	private static final String APPLY_TOOLTIP = "Apply properties to selected tiles"; // todo:
																						// Resource
																						// this
	...
	public TileInstancePropertiesDialog(MapEditor editor) {
		super(YaFrame.get(), DIALOG_TITLE, false);
		this.editor = editor;
