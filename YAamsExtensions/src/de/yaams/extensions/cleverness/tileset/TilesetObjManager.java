...
public class TilesetObjManager extends SimpleObjectManagement {
	...
	public void buildInternContent(BasisListElement selectedObject, FormBuilder f) {
		...
		f.addElement(
				"basic.graphic",
				new FormRessElement(I18N.t("Grafik"), project, "Ressources", t.getGraphic(), Typ.ONLYNAME) {}.setInfoTxt(
						I18N.t("Nach dem Auswählen einer neuen Grafik, muss es neugeladen werden.")).addChangeListener(
		...
		// set basics
		f.getHeader("tileset").setColumn(10);
