...
public class YAamsCore {
	 ...
	 */
	public final static String yaamsversion = "0.6";

	/**
	 * Name of yaams
	 */
	public final static String yaamsname = "Yrp";
	/**
	 * Name of yaams
	 */
	public final static String yaamstitle = "YAams RGSS Player 0.6";
