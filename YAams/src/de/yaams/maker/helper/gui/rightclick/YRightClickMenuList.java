...
public class YRightClickMenuList {
	...
	public static void install(final YSimpleList<?> comp) {
		...
		comp.getList().addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent me) {
				...
				if (me.isPopupTrigger()) {
					...
					// show it
					Point pt = SwingUtilities.convertPoint(me.getComponent(), me.getPoint(), comp.getList());
					menu.show(comp.getList(), pt.x, pt.y);
	...
	static abstract class BaseListAction extends BaseAction<YSimpleList<?>> {
	...
	static class DeleteAction extends BaseListAction {
		...
		public boolean isActive() {
			return !comp.getList().isSelectionEmpty();
		}
	}

	static class AddAction extends BaseListAction {
		private static final long serialVersionUID = -2425514124546515657L;
	...
	static class CopyAction extends BaseListAction {
		private static final long serialVersionUID = -2425514124546515657L;
	...
	static class ImportAction extends BaseListAction {
		private static final long serialVersionUID = -2425514124546515657L;
	...
	static class ExportAction extends BaseListAction {
		private static final long serialVersionUID = -2425514124546515657L;
	...
	static class PasteAction extends BaseListAction {
		...
		@Override
		public boolean isActive() {
			return comp.getObjectSize() > 0 && ClipboardHelper.contains(comp.getObject(0).getClass());
