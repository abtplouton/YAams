 ...
 * 
 */
public class LabelCommand extends EventCommand {
	...
	protected String getInternTitle(EventCode e) {
		String mess = e.getId() == 118 ? "Label {0}" : "Gehe zu {0}";
	...
	public void buildPanel(FormBuilder f, final EventCode e) {
		// add type
		f.addElement("basic.typ",
				CommandFormHelper.buildCodeIdChancer(e, I18N.t("Typ"), new String[] { "119", "118" }, new String[] { "GoTo", "Label" }));

		// add name
		f.addElement("basic.name", RubyForm.getString(I18N.t("Name"), e.getParameters().get(0)));
