 ...
 * 
 */
public class SceneCallCommand extends EventCommand {

	protected static final String[] scenes = { "Main Menu", "Save Menu", "Game Over", "Title Screen" };

	/**
	 * Create a new LabelCommand
	 */
	public SceneCallCommand() {}
	...
	protected String getInternTitle(EventCode e) {
		return I18N.t("Gehe zu {0}", scenes[e.getId() - 351]);
	}
	...
	public void buildPanel(FormBuilder f, final EventCode e) {
		...
		f.addElement(
				"basic.scene",
				new FormComboBox(I18N.t("Gehe zu"), new String[] { "351", "352", "353", "354" }, scenes).selectField(
						Integer.toString(e.getId())).addChangeListener(new FormElementChangeListener() {
