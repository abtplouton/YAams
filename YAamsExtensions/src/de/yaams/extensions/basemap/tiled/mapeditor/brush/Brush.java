...
public interface Brush {
	 ...
	 * @param x
	 *            the tile x-coordinate where the user initiated the paint.
	 * @param y
	 *            the tile y-coordinate where the user initiated the paint.
	 * @param button
	 ...
	 * 
	 * @param x
	 *            the tile x-coordinate of the mouse.
	 * @param y
	 *            the tile y-coordinate of the mouse.
	 * 
	 ...
	 *            The graphics context to draw to.
	 * @param dimension
	 *            The dimension within which the preview should be drawn
	 * @param mv
	 *            The active map view.
	 */
