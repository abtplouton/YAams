...
import de.yaams.core.helper.gui.form.FormFileSelectField;
...
public class NetHelper {
	...
	protected static Object checkRights(String link, boolean text) {
		...
		// return
		// showMessage(I18N.t("Der Zugriff aufs Internet ist deaktiviert. <br>"
		// + "{1}: {0}", link,
		// text ? "Kann die Seite nicht anzeigen" :
		// "Kann die Datei nicht runterladen"), link, true, true, text);
	}
