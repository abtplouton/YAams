...
public final class Resources {
	...
	private static final ResourceBundle resourceBundle = ResourceBundle
			.getBundle(Resources.class.getPackage().getName() + ".resources.gui");
	 ...
	 * 
	 * @param filename
	 *            the filename relative from the resources directory
	...
	/**
	 * Loads the image using {@link #getImage(String)} and uses it to create a
	 * new {@link ImageIcon} instance.
	 * 
	 * @param filename
	 *            the filename of the image relative from the
	 *            <code>resources</code> directory
	 * @return the loaded icon, or <code>null</code> when an error occured while
	 *         loading the image
	 */
	public static Icon getIcon(String filename) {
		try {
			...
			YEx.info("Failed to load: " + filename, t);
		}
		return null;
	}
}
