...
public final class TiledConfiguration {
	...
	/**
	 * Returns the node with the given path name relative from the root of Tiled
	 * configuration.
	 * 
	 * @param pathName
	 *            the path name relative from the root
	...
	/**
	 * Adds the given filename to the top of the recent file list. It also makes
	 * sure it does not occur further down the list.
	 * 
	 * @param mapFile
	 *            the absolute path of the file to add, must not be
	 *            <code>null</code>
	 */
