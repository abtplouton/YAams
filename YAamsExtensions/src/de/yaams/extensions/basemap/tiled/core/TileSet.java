...
import de.yaams.extensions.basemap.tiled.mapeditor.util.TransparentImageFilter;
import de.yaams.extensions.basemap.tiled.mapeditor.util.cutter.BasicTileCutter;
import de.yaams.extensions.basemap.tiled.mapeditor.util.cutter.TileCutter;
import de.yaams.extensions.basemap.tiled.util.NumberedSet;
...
public class TileSet {
	 ...
	 * <b>null</b>.
	 * 
	 * todo: Fix the behaviour of this function? It actually does seem to todo:
	 * invalidate other tile indices due to implementation of todo: NumberedSet.
	 * 
	 * @param i
	 *            the index to remove
	 */
	...
	/**
	 * @param id
	 * @return the image identified by the key, or <code>null</code> when there
	 *         is no such image
	 */
	 ...
	 *             its documentation, I consider this function deprecated. It is
	 *             only used by tiles, but they should in my opinion just use
	 *             their "internalImage". - Bjorn
	 * @param id
	 *            the image id
	...
	public boolean isOneForOne() {
		...
		/*
		 * while (itr.hasNext()) { Tile t = (Tile)itr.next(); if
		 * (t.countAnimationFrames() != 1 || t.getImageId() != t.getId() ||
		 * t.getImageOrientation() != 0) { return false; } }
		 */
