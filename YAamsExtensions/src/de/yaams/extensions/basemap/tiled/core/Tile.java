...
public class Tile {
	...
	/**
	 * Sets the parent tileset for a tile. If the tile is already a member of a
	 * set, and this method is called with a different set as argument, the tile
	 * image is transferred to the new set.
	 * 
	 * @param set
	 */
	...
	/**
	 * Returns the {@link de.yaams.extensions.basemap.tiled.core.TileSet} that
	...
	/**
	 * Draws the tile at the given pixel coordinates in the given graphics
	 * context, and at the given zoom level
	 * 
	 * @param g
	 * @param x
	 * @param y
