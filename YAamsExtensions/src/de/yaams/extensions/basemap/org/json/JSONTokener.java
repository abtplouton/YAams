...
public class JSONTokener {
	...
	/**
	 * Unescape the source text. Convert <code>%</code><i>hh</i> sequences to
	 * single characters, and convert plus to space. There are Web transport
	 * systems that insist on doing unnecessary URL encoding. This provides a
	 * way to undo it.
	 */
	void unescape() {
