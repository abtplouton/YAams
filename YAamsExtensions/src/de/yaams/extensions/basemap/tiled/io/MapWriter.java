...
/**
 * Used by Tiled to denote a plugin for writing maps. The map file can have any
 * format, as long as the MapWriter implementor accepts instances of
 * {@link de.yaams.extensions.basemap.tiled.core.Map} and {@link TileSet}.
 * 
 * $Id$
 */
