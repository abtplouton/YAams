 ...
 * 
 */
public class SetWindowSkinCommand extends EventCommand {
	...
	protected String getInternTitle(EventCode e) {
		return I18N.t("Setze {0}", e.getParameters().get(0).asJavaString());
	}
	...
	public String getName() {
		return I18N.t("Windowskin ändern");
	}
	...
	public void buildPanel(FormBuilder f, EventCode e) {
		...
		f.addElement("basic.windowskin", new FormGraphEle(I18N.t("Window-Skin"), e.getYecl().getProject(), RTP.WINDOWSKIN, (RubyString) e
				.getParameters().get(0), 1, null));
