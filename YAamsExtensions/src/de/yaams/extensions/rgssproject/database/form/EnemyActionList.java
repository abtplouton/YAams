 ...
 * 
 */
public class EnemyActionList extends YSimpleList<Integer> {

	private static final long serialVersionUID = -6652256367688017210L;
	protected EnemyActionPanel panel;
	 ...
	 * @param ary
	 */
	public EnemyActionList(final EnemyActionPanel panel) {
		super();
		this.panel = panel;
